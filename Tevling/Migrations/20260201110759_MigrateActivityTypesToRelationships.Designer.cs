...
namespace Tevling.Migrations
{
    ...
    [Migration("20260201110759_MigrateActivityTypesToRelationships")]
    partial class MigrateActivityTypesToRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tevling.Model.ChallengeActivityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Tevling.Model.ChallengeTemplateActivityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ChallengeTemplateActivityTypes");
                });
            ...
            modelBuilder.Entity("Tevling.Model.ChallengeTemplateActivityType", b =>
                {
                    b.HasOne("Tevling.Model.ChallengeTemplate", "ChallengeTemplate")
                        .WithMany("ChallengeTemplateActivityTypes")
                        .HasForeignKey("ChallengeTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChallengeTemplate");
                });
            ...
            modelBuilder.Entity("Tevling.Model.Challenge", b =>
                {
                    b.Navigation("ChallengeActivityTypes");
                });

            modelBuilder.Entity("Tevling.Model.ChallengeTemplate", b =>
                {
                    b.Navigation("ChallengeTemplateActivityTypes");
                });
